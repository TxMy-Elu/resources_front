        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm space-y-8 text-sm text-content-muted">
            ...
            <section className="space-y-4">
              ...
              <table className="w-full border-collapse text-sm overflow-hidden rounded-xl border border-gray-200">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="border border-gray-200 p-2 text-left font-semibold">Données</th>
                    <th className="border border-gray-200 p-2 text-left font-semibold">Base légale</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-200 p-2">Email, mot de passe</td>
                    <td className="border border-gray-200 p-2">Contrat (création compte)</td>
                  </tr>
                  <tr className="bg-gray-50/70">
                    <td className="border border-gray-200 p-2">Nom, prénom, téléphone</td>
                    <td className="border border-gray-200 p-2">Consentement explicite</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 p-2">Adresse IP, logs</td>
                    <td className="border border-gray-200 p-2">Intérêt légitime (sécurité)</td>
                  </tr>
                  <tr className="bg-gray-50/70">
                    <td className="border border-gray-200 p-2">Newsletter</td>
                    <td className="border border-gray-200 p-2">Consentement opt-in</td>
                  </tr>
                </tbody>
              </table>
            </section>
            ...
            <section className="space-y-4">
              ...
              <table className="w-full border-collapse text-sm overflow-hidden rounded-xl border border-gray-200">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="border border-gray-200 p-2 text-left font-semibold">Type de données</th>
                    <th className="border border-gray-200 p-2 text-left font-semibold">Durée</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-200 p-2">Compte actif</td>
                    <td className="border border-gray-200 p-2">Durée de l&apos;inscription</td>
                  </tr>
                  <tr className="bg-gray-50/70">
                    <td className="border border-gray-200 p-2">Après suppression</td>
                    <td className="border border-gray-200 p-2">30 jours (archives temporaires)</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 p-2">Logs de connexion</td>
                    <td className="border border-gray-200 p-2">90 jours</td>
                  </tr>
                  <tr className="bg-gray-50/70">
                    <td className="border border-gray-200 p-2">Cookies analytiques</td>
                    <td className="border border-gray-200 p-2">13 mois</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-200 p-2">Messages signalés illégaux</td>
                    <td className="border border-gray-200 p-2">3 ans (obligation légale)</td>
                  </tr>
                </tbody>
              </table>
            </section>
            ...
            {/* Infos légales */}
            <div className="bg-blue-50/70 p-6 rounded-2xl border border-blue-100 shadow-sm space-y-2 text-sm text-blue-800">
